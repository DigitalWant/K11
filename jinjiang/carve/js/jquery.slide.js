...
(function($){
	$.fn.Slide=function(options){
		...
		var clickNext = $("." + opts.claNav + " .play_left", $(this));//一钮
		var clickPrev = $("." + opts.claNav + " .play_right", $(this));//一钮
		...
		if(opts.effect=="scroolY"||opts.effect=="scroolTxt"){
			...
			ContentBox.css("width",ContentBoxNum*(slideW + 25));//25为limargin-right距离
			slideWH=slideW;
